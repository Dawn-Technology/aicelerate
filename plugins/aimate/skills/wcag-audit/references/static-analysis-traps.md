...
- Authored dimensions below a threshold are candidates, not automatic failures. Resolve padding, computed size, spacing, overlap, neighboring targets, and normative exceptions; otherwise use NEEDS_REVIEW.
